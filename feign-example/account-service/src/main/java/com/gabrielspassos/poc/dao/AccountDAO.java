...
public class AccountDAO {
    ...
    public AccountDAO() {
        ...
        accountModelList.add(new AccountModel("0002",7080.90,new PersonModel(2)));
        accountModelList.add(new AccountModel("0003",10054.90,new PersonModel(3)));
        accountModelList.add(new AccountModel("0004",80.50,new PersonModel(4)));
